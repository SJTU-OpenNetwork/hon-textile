...
func (x *Thread2) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Thread2) ProtoMessage() {}

func (x *Thread2) ProtoReflect() protoreflect.Message {
	mi := &file_thread2_proto_msgTypes[0]
...
// Deprecated: Use Thread2.ProtoReflect.Descriptor instead.
func (*Thread2) Descriptor() ([]byte, []int) {
	return file_thread2_proto_rawDescGZIP(), []int{0}
}

func (x *Thread2) GetThreadId() string {
	if x != nil {
		return x.ThreadId
	}
	return ""
...
func (x *Thread2List) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Thread2List) ProtoMessage() {}

func (x *Thread2List) ProtoReflect() protoreflect.Message {
	mi := &file_thread2_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Thread2List.ProtoReflect.Descriptor instead.
func (*Thread2List) Descriptor() ([]byte, []int) {
	return file_thread2_proto_rawDescGZIP(), []int{1}
}

func (x *Thread2List) GetItem() []*Thread2 {
	if x != nil {
		return x.Item
	}
	return nil
...
func (x *Thread2Invite) Reset() {
	*x = Thread2Invite{}
	if protoimpl.UnsafeEnabled {
		mi := &file_thread2_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Thread2Invite) Descriptor() ([]byte, []int) {
	return file_thread2_proto_rawDescGZIP(), []int{3}
}
...
func (x *Thread2MessageUpdate) Reset() {
	*x = Thread2MessageUpdate{}
	if protoimpl.UnsafeEnabled {
		mi := &file_thread2_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Thread2MessageUpdate) Descriptor() ([]byte, []int) {
	return file_thread2_proto_rawDescGZIP(), []int{4}
}
...
var file_thread2_proto_rawDesc = []byte{
	...
	,
...
var file_thread2_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_thread2_proto_goTypes = []interface{}{
	(*Thread2)(nil),              // 0: Thread2
	(*Thread2List)(nil),          // 1: Thread2List
	(*Thread2Peer)(nil),          // 2: Thread2Peer
	(*Thread2Invite)(nil),        // 3: Thread2Invite
	(*Thread2MessageUpdate)(nil), // 4: Thread2MessageUpdate
}
var file_thread2_proto_depIdxs = []int32{
	0, // 0: Thread2List.item:type_name -> Thread2
...
func file_thread2_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_thread2_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_thread2_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
