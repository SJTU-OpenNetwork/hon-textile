...
func (x *RecordReport) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RecordReport) ProtoMessage() {}

func (x *RecordReport) ProtoReflect() protoreflect.Message {
	mi := &file_record_service_proto_msgTypes[0]
...
// Deprecated: Use RecordReport.ProtoReflect.Descriptor instead.
func (*RecordReport) Descriptor() ([]byte, []int) {
	return file_record_service_proto_rawDescGZIP(), []int{0}
}

func (x *RecordReport) GetKey() string {
	if x != nil {
		return x.Key
	}
	return ""
...
func (x *RecordReport) GetStart() *timestamp.Timestamp {
	if x != nil {
		return x.Start
	}
	return nil
...
func (x *RecordReport) GetEnd() *timestamp.Timestamp {
	if x != nil {
		return x.End
	}
	return nil
...
var file_record_service_proto_rawDesc = []byte{
	...
	0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x80, 0x01, 0x0a, 0x0c, 0x52, 0x65, 0x63, 0x6f,
	0x72, 0x64, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x30, 0x0a, 0x05, 0x73, 0x74,
	...
	0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x54, 0x69, 0x6d, 0x65,
	0x73, 0x74, 0x61, 0x6d, 0x70, 0x52, 0x03, 0x65, 0x6e, 0x64, 0x42, 0x1c, 0x0a, 0x16, 0x73, 0x6a,
	0x74, 0x75, 0x2e, 0x6f, 0x70, 0x65, 0x6e, 0x6e, 0x65, 0x74, 0x2e, 0x74, 0x65, 0x78, 0x74, 0x69,
	0x6c, 0x65, 0x70, 0x62, 0x5a, 0x02, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_record_service_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_record_service_proto_goTypes = []interface{}{
	(*RecordReport)(nil),        // 0: RecordReport
	(*timestamp.Timestamp)(nil), // 1: google.protobuf.Timestamp
}
var file_record_service_proto_depIdxs = []int32{
	1, // 0: RecordReport.start:type_name -> google.protobuf.Timestamp
	1, // 1: RecordReport.end:type_name -> google.protobuf.Timestamp
